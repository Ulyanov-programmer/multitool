const navigation = document.querySelector("#main-navigation"), activeLink = navigation.querySelector("a.active"), isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
